...
file_path = "./testing_data_synthetic_4.xlsx"
...
plt.title("Call Option Prices Over Time Testing Dataset")
plt.xlabel("Date")
plt.ylabel("Price")
plt.legend()
plt.grid(True)
...
plt.title("Put Option Prices Over Time Testing Dataset")
plt.xlabel("Date")
plt.ylabel("Price")
plt.legend()
plt.grid(True)
...
plt.title("Rolling Volatility (Nominal in USD$) Trends Over Time Testing Dataset")
plt.xlabel("Date")
...
plt.title("Rolling Volatility (%)) Trends Over Time Testing Dataset")
plt.xlabel("Date")
