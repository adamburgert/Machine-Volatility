...
initial_price = 190.623391982309  # Initial price of the asset (e.g., GLD)
...
dates = pd.date_range(start="2007-05-09", periods=n_days, freq="B")  # Business days
...
with pd.ExcelWriter("testing_data_synthetic_4.xlsx") as writer:
