...
n_days = 15090  # Number of days (approximately 8 years)
initial_price = 100  # Initial price of the asset (e.g., GLD)
...
with pd.ExcelWriter("training_data_synthetic_4.xlsx") as writer:
